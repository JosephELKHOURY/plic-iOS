...
+ (ARGeoCoordinate *)coordinateWithLocation:(CLLocation *)location locationTitle:(NSString*) titleOfLocation locationDescription:(NSString*) descriptionOfLocation
{
    ...
    [newCoordinate setDescription: descriptionOfLocation];
...
+ (ARGeoCoordinate *)coordinateWithLocation:(CLLocation *)location fromOrigin:(CLLocation *)origin {
	...
	ARGeoCoordinate *newCoordinate = [ARGeoCoordinate coordinateWithLocation:location locationTitle:@"" locationDescription:@""];
